...
import play from '../assets/static/icons8-circled-play-50.png'
import add from '../assets/static/icons8-add-50.png'
    ...
    <div className="carousel-item">
        ...
        <div className="carousel-item__details">
            <div>
                ...
                <img className="carousel-item__details--img" src={add} alt="Add"/>
            </div>
