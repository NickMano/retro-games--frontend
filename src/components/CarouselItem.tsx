...
const CarouselItem = () => (
    <div className="carousel-item">
        ...
        <div className="carousel-item__details">
            <div>
                <img className="carousel-item__details--img" src="./img/icons8-circled-play-50.png" alt="Play"/>
                <img className="carousel-item__details--img" src="./img/icons8-add-50.png" alt="Add"/>
            </div>
